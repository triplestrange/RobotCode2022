...
public class ThreeBallB extends SequentialCommandGroup {
  /** Creates a new ThreeBallB. */
  public ThreeBallB(SwerveDrive swerve, Intake intake, Conveyor conveyor, Hood hood, Turret turret, Shooter shooter) {
    ...
    Command threeBallB = new InstantCommand(() -> {
