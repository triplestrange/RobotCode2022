...
public class ThreeBallA extends SequentialCommandGroup {
  /** Creates a new ThreeBallA. */
  public ThreeBallA(SwerveDrive swerve, Intake intake, Conveyor conveyor, Hood hood, Turret turret, Shooter shooter) {
